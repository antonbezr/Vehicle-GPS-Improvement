...
In this project I attempted to improve GPS error by creating and implementing a secondary positioning system for a vehicle to use alongside GPS. In order to develop this secondary system, I used a variety of sensors connected to a development board. Then, in order to combine these two positioning systems, I use a Kalman Filter. All of my testing and design was done using an RC car in order to simulate a real vehicle.
